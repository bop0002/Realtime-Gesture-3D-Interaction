...
\begin{enumerate}
    ...
    \item \textbf{Giảm hiện tượng rung giật và nâng cao độ ổn định tương tác:} Áp dụng thành công thuật toán bộ lọc thông thấp thích nghi One Euro Filter kết hợp với cơ chế giới hạn vùng hoạt động (\textit{Active Region Remapping}) giúp giảm thiểu tối đa hiện tượng rung lắc tọa độ của đầu ngón tay khi tương tác. Đồng thời, việc cài đặt giải thuật dung hợp cử chỉ (\textit{BothMatch}) và trễ chống nhiễu cầm nắm (\textit{Debounce}) đã giải quyết triệt để tình trạng nhảy nhãn nhầm lẫn tức thời của mô hình AI, giúp trải nghiệm tương tác vật lý (cầm/nắm/ném) đạt độ ổn định và chính xác cao trong thực tế.
\end{enumerate}
